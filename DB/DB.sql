...
-- Dumping data for table wbc.user: ~22 rows (approximately)
...
-- Dumping data for table wbc.user_ext: ~5 rows (approximately)
...
-- Dumping data for table wbc.user_role: ~23 rows (approximately)
